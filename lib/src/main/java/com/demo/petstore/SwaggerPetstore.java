...
import com.demo.petstore.utils.SpeakeasyHTTPClient;
...
public class SwaggerPetstore {
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = com.demo.petstore.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		 ...
		 */
		public SwaggerPetstore build() throws Exception {
			...
			return new SwaggerPetstore(this.sdkConfiguration);
		}
	}
	...
	private SwaggerPetstore(SDKConfiguration sdkConfiguration) throws Exception {
