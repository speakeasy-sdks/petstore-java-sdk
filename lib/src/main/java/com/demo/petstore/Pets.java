...
public class Pets {
    ...
    public com.demo.petstore.models.operations.CreatePetsResponse createPets(com.demo.petstore.models.shared.Pet request) throws Exception {
        ...
        com.demo.petstore.models.operations.CreatePetsResponse res = new com.demo.petstore.models.operations.CreatePetsResponse(contentType, httpRes.statusCode(), httpRes) {{
            error = null;
        }};
    ...
    public com.demo.petstore.models.operations.ListPetsResponse listPets(com.demo.petstore.models.operations.ListPetsRequest request) throws Exception {
        ...
        com.demo.petstore.models.operations.ListPetsResponse res = new com.demo.petstore.models.operations.ListPetsResponse(contentType, null, httpRes.statusCode(), httpRes) {{
            pets = null;
            error = null;
        }};
    ...
    public com.demo.petstore.models.operations.ShowPetByIdResponse showPetById(com.demo.petstore.models.operations.ShowPetByIdRequest request) throws Exception {
        ...
        com.demo.petstore.models.operations.ShowPetByIdResponse res = new com.demo.petstore.models.operations.ShowPetByIdResponse(contentType, httpRes.statusCode(), httpRes) {{
            pet = null;
            error = null;
        }};
